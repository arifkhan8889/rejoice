        ...
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption font-dark">
                    ...
                    <span class="caption-subject bold uppercase"> Subscription Types List</span>
                </div>
            </div>
            ...
            <div class="portlet-body">
                <div class="table-toolbar">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="btn-group">
                                <a href="{{url("subscription/create")}}"  class="btn sbold green"> Add New
...
$(document).ready(function () {
    ...
    var url = "{{ URL::to('subscription')}}";
    var table = $('#subscription_list').DataTable ({
        "paging": true,
        "ordering": true,
        "info": true,
           ...
           success:function(response){
               if(response=='true'){
                 table
                        .draw();
                $('#cover').fadeOut(200);
                $('.delete_show_msg').show().html('Subscription Deleted Successfully!!!');
               }            
           }
        });
    }
