        ...
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption font-dark">
                    ...
                    <span class="caption-subject bold uppercase"> Videos List</span>
                </div>
            </div>
            ...
            <div class="portlet-body">
                <div class="table-toolbar">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="btn-group">
                                <a href="{{url("video/create")}}"  class="btn sbold green"> Add New
...
<!--                            <div class="btn-group">
                ...
                <div id="sample_1_wrapper" class="dataTables_wrapper no-footer">
                    <div class="table-section">
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="video_list">
                            <thead>
                                <tr>
                                    <th>
    ...
    var table = $('#video_list').DataTable ({
       ...
       "rowCallback": function (row, data,index) {   
        ...
        $('td:last-of-type', row).html(
            ...
            ' <a type="button" id="delete_video'+data.id+'" title="Delete" data-id='+data.id+' class="btn btn-icon-only red video_delete"><i class="fa fa-trash"></i></a>'
        );
    },
    });  
         ...
         $.ajax({
           ...
           success:function(response){
               if(response=='true'){
                ...
                $('#cover').fadeOut(200);
//                $('.delete_msg').show();
                $('.delete_show_msg').show().html('Video Deleted Successfully!!!');
               }            
           }
        });
    }
    });
    $('#video_list').find('.sorting_asc').first().removeClass('sorting_asc');
